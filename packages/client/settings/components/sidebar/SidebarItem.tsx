...
export function SidebarItem(props: Props) {
  return (
    <li>
      <a
        class="flex p-2 mb-1 transition bg-primary-50 hover:bg-primary-100 dark:bg-primary-600 dark:hover:bg-primary-500 text-gray-800 dark:text-white shadow hover:shadow-lg"
        href={props.href}
      >
        {props.children}
