...
export function JourneyDirectionsResultItem(props: Props) {
  ...
  return (
    <Link
      action={props.action}
      href={props.href}
      class="flex flex-col snap-start w-32 md:w-auto shadow-xl h-full transition-colors text-black dark:text-white bg-blue-100 hover:bg-blue-200 dark:bg-blue-700 dark:hover:bg-blue-600"
